...
class GlassFusionNode(Node):
    def __init__(self):
        ...
        # Parameters
        self.declare_parameter('radar_fov_deg', 40.0)        # half-power beamwidth (deg)
        self.declare_parameter('glass_threshold_m', 0.1)     # depth-consistency tolerance tau (m)
        self.declare_parameter('radar_min_intensity', 0.0)   # min peak amplitude to trust radar
        self.radar_min_intensity = self.get_parameter('radar_min_intensity').value
